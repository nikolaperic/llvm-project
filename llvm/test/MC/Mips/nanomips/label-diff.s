...
1:	lbux	$a1,$a2($a3)
  ...
  .shword (.L1 - .L2)		# CHECK: {{0+}}8  00000203 R_NANOMIPS_NEG	{{0+}}2   .L2 + 0
  ...
  .byte (.L1 - .L2)		# CHECK: {{0+}}c  00000203 R_NANOMIPS_NEG	{{0+}}2   .L2 + 0
  ...
  .sbyte (.L1 - .L2)		# CHECK: {{0+}}e  00000203 R_NANOMIPS_NEG {{0+}}2         .L2 + 0
